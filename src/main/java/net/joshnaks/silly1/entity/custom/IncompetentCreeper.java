...
public class IncompetentCreeper extends CreeperEntity implements SkinOverlayOwner {
    ...
    public IncompetentCreeper(EntityType<? extends IncompetentCreeper> entityType, World world) {
    ...
    protected void dropEquipment(DamageSource source, int lootingMultiplier, boolean allowDrops) {
        ...
        if (entity != this && entity instanceof IncompetentCreeper creeperEntity) {
    ...
    static {
        FUSE_SPEED = DataTracker.registerData(IncompetentCreeper.class, TrackedDataHandlerRegistry.INTEGER);
        CHARGED = DataTracker.registerData(IncompetentCreeper.class, TrackedDataHandlerRegistry.BOOLEAN);
        IGNITED = DataTracker.registerData(IncompetentCreeper.class, TrackedDataHandlerRegistry.BOOLEAN);
    }
}
